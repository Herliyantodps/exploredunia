                                ...
                                <div class="card-body">
                                    <form class="form-sample" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col-sm-12 pl-0 pr-0">
                                                    <input type="text" class="form-control" name="packagename"
                                                        id="packagename" placeholder="Create Package Name" required>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 pl-md-0">
                                                ...
                                                <div class="col-sm-12 pl-0 pr-0">
                                                    <input type="text" class="form-control" name="packagetype"
                                                        id="packagetype"
                                                        placeholder=" Package Type eg- Outdoor / Indoor" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 pl-md-0">
                                                <label class="col-sm-12 pl-0 pr-0">Price in Rp</label>
                                                <div class="col-sm-12 pl-0 pr-0">
                                                    <input type="text" class="form-control" name="packageprice"
                                                        id="packageprice" placeholder=" Price is Rp" required>
                                                </div>
                                            </div>
                                        </div>
