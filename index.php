    ...
    <section id="introText">
        <div class="container">
            <div class="text-center adeInDown animated animated" data-wow-delay=".5s"
                ...
                <h1>Dunia Menunggumu, Ayo Mulai Petualangan Baru!</h1>
                <p>Nikmati Pengalaman Tak Terlupakan dengan Paket Tour Kami yang Penuh Petualangan. </p>
            </div>
        </div>
    </section>
    <!--About-->
    <section id="aboutUs" class="secPad">
        <div class="container">
            ...
            <div class="row adeInDown animated animated" data-wow-delay=".5s"
                ...
                <div class="col-md-8">
                    <p>Explore Dunia adalah platform online yang didedikasikan untuk menginspirasi dan memandu para
                        pecinta perjalanan dalam menjelajahi keindahan dunia. Kami menyediakan informasi terkini tentang
                        destinasi wisata, tips perjalanan, dan pengalaman pribadi yang dapat membantu Anda merencanakan
                        liburan yang tak terlupakan. Kami percaya bahwa perjalanan adalah cara terbaik untuk memperluas
                        wawasan, memperkaya
                        pengalaman, dan menciptakan kenangan indah. Melalui konten kami yang informatif, inspiratif, dan
                        beragam, kami berkomitmen untuk membantu Anda menemukan tujuan wisata yang menarik, mengenal
                        budaya baru, dan menikmati petualangan yang tak terlupakan. Semoga contoh kalimat di atas dapat
                        memberikan gambaran tentang bagaimana "About Us" dari website
                        Explore Dunia. Anda dapat menyesuaikan kalimat tersebut dengan karakteristik dan nilai-nilai
                        unik dari website atau bisnis Anda.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="packages" class="secPad">
        <div class="container">
            <div class="heading text-center">
                ...
                <p>Beralihlah dari impian menjadi kenyataan dengan memilih paket populer dari Explore Dunia.</p>
            </div>
            <div class="">
                <h3>Package List</h3>
    ...
    <section id="portfolio" class="page-section section appear clearfix secPad">
        <div class="container">
            <div class="heading text-center">
                <!-- Heading -->
                <h2>Gallery</h2>
                <p>Lihat dunia dari ketinggian dengan foto-foto satelit berkualitas tinggi yang menampilkan pemandangan
                    alam, kota-kota, dan situs bersejarah.
                </p>
            </div>
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                <div class="heading text-center">
                    ...
                    <p>Terima kasih telah mengunjungi profil saya. Jika Anda ingin menghubungi saya, silakan isi
            ...
            <div class="row mrgn30">
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <address>
                        Explore Dunia<br>
                        Jl. Tirto Utomo No.52 Desa Landungsari <br>
                        Kec.Dau, Kab.Malang, Jawa Timur, Indonesia.
                        <br>
                    </address>
                    <h4>Phone:</h4>
                    <address>
